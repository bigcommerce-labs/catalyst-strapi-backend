...
export interface ApiQuestionCategoryQuestionCategory
  ...
  attributes: {
    ...
    slug: Attribute.UID<'api::question-category.question-category', 'name'> &
      Attribute.Required;
...
export interface ApiStaticSiteContentStaticSiteContent
  extends Schema.SingleType {
  collectionName: 'static_site_contents';
  info: {
    singularName: 'static-site-content';
    pluralName: 'static-site-contents';
    displayName: 'Static Site Content';
    description: '';
  };
  options: {
    draftAndPublish: false;
  ...
  attributes: {
    customer_service_title: Attribute.String &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    customer_service_tagline: Attribute.String &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    customer_service_anchor_text: Attribute.String &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    customer_service_anchor_link: Attribute.String &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    news_vanity_url: Attribute.String &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
    ...
    updatedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::static-site-content.static-site-content',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::static-site-content.static-site-content': ApiStaticSiteContentStaticSiteContent;
    }
  }
}
